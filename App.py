...
if st.sidebar.button("🚀 Simülasyonu Başlat"):
    ...
    ax2.plot(jelli_mikroorganizma, label="Jel Formunda Mikroorganizma", color='green')
    ax2.set_title("🧊 Mikroorganizmların Jelli ve Jelsiz Formunun Radyasyon Direncine Etkisi")
